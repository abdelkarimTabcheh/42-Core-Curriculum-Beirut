...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/23 10:12:22 by atabcheh          #+#    #+#             */
/*   Updated: 2024/07/23 18:28:55 by atabcheh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_map(t_game *game)
{
	...
	if (game->score == 0)
		ft_exit("Error\nThere's no bone", game);
	else if (game->exit == 0)
		ft_exit("Error\nThere's no house", game);
	else if (game->exit > 1)
		ft_exit("Error\nJust one house per map", game);
	else if (game->player == 0)
		ft_exit("Error\nThere's no Dog", game);
	else if (game->player > 1)
		ft_exit("Error\nJust one Dog per map", game);
}
