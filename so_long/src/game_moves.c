...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/23 10:12:29 by atabcheh          #+#    #+#             */
/*   Updated: 2024/07/23 18:32:29 by atabcheh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	move_dog(t_game *game, int col, int line, int pressed_key)
{
	int	valid;
	int	tcol;
	int	tline;
...
int	key_handler(int keycode, t_game *game)
{
	...
	if (keycode == A)
		...
		close_window(game);
	if (game->end_game != 1)
		move_dog(game, col, line, keycode);
	return (0);
}
